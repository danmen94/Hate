...
{	
	...
	public static function defaultConstants()
	{
		return array(
			...
			'SUITE_UNIQUE_KEY'					=> mb_substr( md5( '13mafia' . '$Rev: 3023$'), 10, 10 ),
			'CACHEBUST_KEY'						=> mb_substr( md5( '13mafia' . '$Rev: 3023$'), 10, 10 ), // This looks unnecessary but SUITE_UNIQUE_KEY can be set to a constant constant in constants.php whereas we need a version specific constant for cache busting.
