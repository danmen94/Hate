...
class _databases extends \IPS\Node\Controller
{
	...
	public function form()
	{
		...
		$form->add( new \IPS\Helpers\Form\YesNo( 'category_can_view_others', ( $category !== NULL and $category->can_view_others ) ? TRUE : FALSE, FALSE, array(), NULL, NULL, NULL, 'category_can_view_others' ) );
