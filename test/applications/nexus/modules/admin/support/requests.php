...
{	
	...
	protected function manage()
	{
		...
		if ( \IPS\Request::i()->isAjax() )
		{
			\IPS\Output::i()->json( array(
				'form'		=> $form,
				'results'	=> \IPS\Theme::i()->getTemplate( 'support' )->requestsTable( $results, $pagination, $groupByDepartment, $sortBy, $sortDir, $tracked, $participatedIn )
			) );
			return;
		}
		else
		{
			...
			\IPS\Output::i()->output .= \IPS\Theme::i()->getTemplate( 'support' )->requests( $form, $stream, $results, $pagination, $groupByDepartment, $sortBy, $sortDir, $tracked, $participatedIn );
		}
	...
	protected function notifications()
	{
		...
		try
		{
			$defaultContent = \IPS\Db::i()->select( 'content', 'nexus_support_default_content', array( 'staff_id=?', \IPS\Member::loggedIn()->member_id ) )->first();
		}
		catch ( \UnderflowException $e )
		{
			$defaultContent = NULL;
		}
		$form->add( new \IPS\Helpers\Form\Editor( 'nexus_default_support_content', $defaultContent, FALSE, array( 'app' => 'nexus', 'key' => 'Support', 'autoSaveKey' => 'default_content', 'tags' => array(
		...
		if ( $values = $form->values() )
		{
			\IPS\Db::i()->insert( 'nexus_support_default_content', array(
