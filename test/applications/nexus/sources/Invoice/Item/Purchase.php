...
abstract class _Purchase extends \IPS\nexus\Invoice\Item
{
	...
	public static function acpEdit( \IPS\nexus\Purchase $purchase, \IPS\Helpers\Form $form, $renewals )
	{
		...
		if ( !$purchase->grouped_renewals and ( !$purchase->billing_agreement or $purchase->billing_agreement->status() == \IPS\nexus\Customer\BillingAgreement::STATUS_CANCELED ) )
		{
		...
		if ( !$purchase->billing_agreement or $purchase->billing_agreement->status() == \IPS\nexus\Customer\BillingAgreement::STATUS_CANCELED )
		{
