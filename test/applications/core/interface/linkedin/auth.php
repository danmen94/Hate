...
{
	$destination = \IPS\Http\Url::internal( "app=core&module=system&controller=login&loginProcess=linkedin", $state[0], 'login', NULL, \IPS\Settings::i()->logins_over_https )->setQueryString( array( 'state' => $state[1], 'code' => \IPS\Request::i()->code ) );
	if ( !empty( $state[2] ) )
	{
